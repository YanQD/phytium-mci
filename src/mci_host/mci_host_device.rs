...
pub(crate) trait MCIHostDevice {
    ...
    fn execute_tuning(&self, tuning_cmd: u32, rev_buf: &mut [u32], block_size: u32) -> MCIHostStatus;
    ...
    // todo 同上
    fn card_int_init(&self, sdio_int: &MCIHostCardInt) -> MCIHostStatus;
